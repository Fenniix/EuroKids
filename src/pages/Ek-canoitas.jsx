...
import { NavbarP, FooterP, ClaseMuestra, Backtop, GaleriaAni, Ventajas } from "../components";
  ...
  return (
    <>
      ...
      {/* <div className="ventajas">
        <h2 className="d-flex justify-content-center mt-3">Ventajas de elegir EuroKids Canoitas</h2>
