  ...
  return(
    <>
      <Card className="card-footer">
        <Card.Body className="row text-center p-0 justify-content-evenly">

          <Card.Body className="img-position">
            <motion.img 
              alt="EuroKids Logo" 
          ...
          <Card.Body className="derechos">
            <h5 className="fw-bold">¡Contáctanos!</h5>
            <div className="horarios">
              <p><img src="src/assets/icons/Phone-wts.png" alt="" width={"8%"} className="me-1"/>+52 961 180 9491</p>
              <p className="pt-3 pb-2">Horarios de atención</p>
              <p>Lunes a Viernes de 11:00 a.m. a 7:00 p.m.</p>
              <p>Sábados de 9:00 a.m. a 3:00 p.m.</p>
            </div>
          </Card.Body>

          <Card.Body className="icons-position row">

            <Card.Link href="https://www.facebook.com/eurokidsidiomas/" className="link-width">
            ...
            <Card.Link href="https://www.instagram.com/eurokidsidiomas/" className="link-width">
        ...
        <Card.Body className="text-center">
          <Card.Text>© Euro Centro de Idiomas de México S.C. © todos los derechos reservados</Card.Text>
        </Card.Body>
