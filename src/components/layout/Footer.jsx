  ...
  return(
    <>
      <Card className="card-footer">
        <Card.Body className="prueba-re p-0">
          ...
          <Card.Link href="https://react-bootstrap.github.io/" className="link-width">
            <div className="icon-ani ani-facebook">
              ...
              {/*<Card.Img src="src/assets/icons/Facebook.png" className="redes-icons"></Card.Img>*/}
            </div>
          </Card.Link>
          ...
          <Card.Link href="https://react-bootstrap.github.io/" className="link-width">
            <div className="icon-ani ani-instagram">
              ...
              {/*<Card.Img src="src/assets/icons/instagram.png" className="redes-icons"></Card.Img>*/}
            </div>
          </Card.Link>
          ...
          <Card.Link href="https://react-bootstrap.github.io/" className="link-width">
            <div className="icon-ani ani-twitter">
              ...
              {/*<Card.Img src="src/assets/icons/Twitter.png" className="redes-icons"></Card.Img>*/}
            </div>
          </Card.Link>
